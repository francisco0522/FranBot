...
const SOCIAL_LINKS = [
  {
    id: 'github',
    label: 'GitHub',
    description: 'Ve el código y contribuciones',
  ...
  },
  {
    ...
    color: 'hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300 dark:hover:border-blue-600',
  },
  {
    id: 'email',
    label: 'Email',
    ...
    color: 'hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-300 dark:hover:border-primary-700',
  },
  {
    id: 'website',
    label: 'Website',
    description: 'Blog y artículos técnicos',
    ...
    color: 'hover:text-accent-600 dark:hover:text-accent-400 hover:border-accent-300 dark:hover:border-accent-700',
  },
]
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Contacto</h1>
          <p className="text-slate-500 dark:text-slate-400">
            ¿Quieres hablar con Francisco? Estos son los mejores canales.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary-500 to-accent-600 rounded-2xl p-6 mb-8 text-white shadow-lg">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs mt-0.5">📍 {CANDIDATE.location}</p>
            </div>
          </div>
